@switch($name)
    @case('check')
        <svg {{ $attributes->except('name') }} fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    @case('heart')
        <svg {{ $attributes->except('name') }} fill="currentColor" viewBox="0 0 24 24">
    ...
    @case('pause')
        <svg {{ $attributes->except('name') }} fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
