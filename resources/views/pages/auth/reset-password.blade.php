        ...
        <form method="POST" action="{{ route('password.update') }}" class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-1.5">
                ...
                <input
                    ...
                    readonly
                    autocomplete="email"
                    class="w-full rounded-lg border border-neutral-200 bg-neutral-50 px-3.5 py-2.5 text-[15px] text-neutral-900 outline-none transition focus:border-neutral-400 focus:ring-2 focus:ring-neutral-900/10 @error('email') border-red-400 @enderror"
                />
                @error('email')
