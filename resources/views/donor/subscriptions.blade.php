                    ...
                    <div class="mt-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                        @php
                            $statusClass = match ($subscription->status) {
                                ...
                                \App\Enums\SubscriptionStatus::Cancelled         => 'bg-red-50 text-red-600 border-red-200',
                                \App\Enums\SubscriptionStatus::PastDue           => 'bg-amber-50 text-amber-700 border-amber-200',
                                \App\Enums\SubscriptionStatus::Failed            => 'bg-red-50 text-red-700 border-red-200',
                                ...
                                \App\Enums\SubscriptionStatus::Completed        => 'bg-blue-50 text-blue-700 border-blue-200',
                            };
            ...
            <div x-show="!increaseSuccess">
                ...
                <div x-show="increaseSelected === 'custom'" x-transition.opacity.duration.200ms class="mt-5">
                    ...
                    <div class="relative max-w-sm">
                        <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 pr-2 text-base font-bold text-slate-400" x-text="increaseSubscription?.symbol"></span>
                        <input type="number"
                               step="0.01"
                               min="1"
                               max="99999.99"
