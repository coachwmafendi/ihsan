...
<div>
    @if ($isCompact)
        <div class="{{ $isPopup ? 'p-6' : 'px-4 py-5 sm:px-5' }}">
            <div class="mb-4 flex items-center gap-3">
                ...
                <div class="min-w-0">
                    <p class="truncate text-sm font-medium text-slate-500">{{ $organization->name }}</p>
    ...
    @endif
                ...
                <div
                    class="{{ $showShadow ? 'shadow-xl' : 'shadow-sm' }} {{ $isPopup ? '' : ($isEmbed ? 'p-5 sm:p-6' : 'p-6') }}"
