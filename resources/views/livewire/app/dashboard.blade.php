...
>
    ...
    <div class="space-y-8">
        <script>
            ...
            function renderDonutChart(el, data, description, title) {
                ...
                const ctx = canvas.getContext('2d');
                // Hues ordered so neighbours stay apart for colourblind readers;
                // blue-500 next to blue-600 read as one colour in a two-slice chart.
                const colors = ['#2563eb', '#f59e0b', '#14b8a6', '#f43f5e', '#a855f7', '#10b981', '#f97316', '#06b6d4', '#6366f1', '#84cc16'];
    ...
    <div class="grid grid-cols-2 gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <x-ui.stat-card
            ...
            value-class="text-lg sm:text-2xl font-semibold tracking-tight text-gray-950 dark:text-white"
        />
        <x-ui.stat-card
            label="Donors"
                ...
                <table class="min-w-full divide-y divide-slate-200">
                    <thead>
                        <tr class="bg-slate-50">
                            ...
                            <th scope="col" class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500">Date (MYT)</th>
                        </tr>
                    </thead>
