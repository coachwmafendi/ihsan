                            ...
                            <div>
                                ...
                                <div class="flex">
                                    <input
                                        ...
                                        onblur="if (this.value !== '') { this.value = Number(this.value).toFixed(2); }"
                ...
                <div class="sticky top-8 rounded-xl border border-slate-200 bg-slate-50 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between gap-x-4 border-t border-slate-200 pt-3 text-sm font-semibold">
                            ...
                            <span class="text-slate-900">{{ $this->getGrandTotal() }}</span>
                        </div>
                    </div>
                    <button
                        type="button"
                        ...
                        try {
                            if (paymentMethod === 'new_card') {
                                if (! this.stripe || ! this.cardElement) {
                                    this.errorMessage = 'Payment form is not ready. Please refresh the page.';
