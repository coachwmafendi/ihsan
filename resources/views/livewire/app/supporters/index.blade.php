...
<div class="space-y-6">
    ...
    {{-- Quick Export Modal --}}
    <flux:modal wire:model="showExportModal" name="quick-export-supporters" class="max-h-[85vh] max-w-md">
        <form
            method="GET"
            action="{{ route('app.supporters.export') }}"
        ...
        >
            <div class="shrink-0">
                <h3 class="text-lg font-semibold text-slate-900">Export supporters</h3>
            ...
            <div class="flex shrink-0 justify-end gap-3 pt-2">
                ...
                <x-ui.button type="submit" variant="primary" x-bind:disabled="loading">
                    ...
                    <span x-text="loading ? 'Exporting...' : 'Export supporters'"></span>
                </x-ui.button>
            </div>
        </form>
    </flux:modal>
