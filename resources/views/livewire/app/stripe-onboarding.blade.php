...
<div class="mx-auto max-w-2xl space-y-8 py-12">
    @if (! $alreadyConnected && ! $showSuccessModal)
            ...
            <div class="w-full max-w-md rounded-xl bg-white p-6 text-center shadow-lg">
                ...
                <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
                    <button
                        ...
                        class="inline-flex items-center justify-center rounded-lg bg-white px-6 py-2.5 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50"
                    >
                        Go to Dashboard
                    </button>
                    ...
                    <button
                        type="button"
                        wire:click="goToStripeSettings"
                        class="inline-flex items-center justify-center rounded-lg bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition"
                    >
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div class="w-full max-w-md rounded-xl bg-white p-6 text-center shadow-lg">
                ...
                <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
                    <button
                        type="button"
                        wire:click="closeAlreadyConnectedModal"
                        class="inline-flex items-center justify-center rounded-lg bg-white px-6 py-2.5 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50"
                    >
                        Close
                    </button>
