...
<div class="space-y-4">
            ...
            >
                <div class="rounded-xl border border-gray-200 bg-white px-6 py-4 shadow-lg dark:border-gray-700 dark:bg-gray-800">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Loading recurring plans...</span>
                    </div>
                </div>
            </div>
        </div>
    @else
        <x-ui.empty-state
            ...
            description="Recurring donation plans will appear here once supporters set up monthly or yearly giving."
        />
    @endif
</div>
</x-filament-panels::page>
