...
<div class="divide-y divide-gray-100 dark:divide-gray-800">
    <div class="flex py-3">
        <span class="w-36 shrink-0 text-sm text-gray-500 dark:text-gray-400">Name</span>
        <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $donor?->name ?? '—' }}</span>
    </div>

    <div class="flex py-3">
        <span class="w-36 shrink-0 text-sm text-gray-500 dark:text-gray-400">Email</span>
        <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $donor?->email ?? '—' }}</span>
    </div>

    <div class="flex py-3">
        <span class="w-36 shrink-0 text-sm text-gray-500 dark:text-gray-400">Language</span>
        <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $language }}</span>
    </div>

    <div class="flex py-3">
        <span class="w-36 shrink-0 text-sm text-gray-500 dark:text-gray-400">Phone</span>
        <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $donor?->phone ?: '—' }}</span>
    </div>

    <div class="flex py-3">
        <span class="w-36 shrink-0 text-sm text-gray-500 dark:text-gray-400">Mailing address</span>
