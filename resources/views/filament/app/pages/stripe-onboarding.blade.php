<x-filament::page>
    <div class="flex flex-col items-center justify-center py-16 text-center">
        <div class="mx-auto mb-8 flex items-center justify-center gap-4">
            <div class="flex h-16 w-40 items-center justify-center rounded-xl bg-white px-6 ring-1 ring-amber-200 dark:bg-gray-800 dark:ring-amber-700">
            ...
            <div class="flex size-16 items-center justify-center rounded-full bg-amber-100 dark:bg-amber-900/30">
                <x-heroicon-o-link class="size-8 text-amber-600 dark:text-amber-400" />
            </div>
        </div>
