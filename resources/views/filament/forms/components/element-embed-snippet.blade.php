...
JS;
    ...
    @if ($embedCode)
    <div class="col-span-full space-y-4" wire:key="embed-snippet-{{ md5($embedCode) }}">
        ...
        >
            ...
            <x-ui.tooltip text="Select and copy manually">
                <pre
                    id="embed-code-{{ $token }}"
                    class="overflow-x-auto cursor-pointer select-all p-4 text-xs leading-relaxed text-zinc-700 transition hover:bg-zinc-100/50"
