        ...
        @elseif($type === 'popup')
            ...
            <div class="relative flex min-h-[300px] w-full items-center justify-center rounded-xl bg-zinc-50/80 p-4">
                <div class="relative w-full max-w-sm overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-zinc-200/60">
                    <button type="button" class="absolute right-0 top-0 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-white text-zinc-500 shadow-md transition hover:bg-zinc-100 hover:text-zinc-900">
