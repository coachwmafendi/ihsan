...
<body style="font-family: Manrope, sans-serif; line-height: 1.6; color: #1a1a2e;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        <h1 style="color: #8b5cf6;">Large Donation Received! 🎉</h1>

        <p>Hi <strong>{{ $donation->campaign->organization->name }}</strong>,</p>

        <p>A large donation of <strong>RM {{ number_format($donation->gross_amount, 2) }}</strong> has been received for <strong>{{ $donation->campaign->title }}</strong>.</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tr><td style="padding: 8px; border-bottom: 1px solid #e2e8f0; color: #64748b;">Amount</td><td style="padding: 8px; border-bottom: 1px solid #e2e8f0; font-weight: 600; font-size: 1.25rem; color: #8b5cf6;">RM {{ number_format($donation->gross_amount, 2) }}</td></tr>
        ...
        <p style="font-size: 0.875rem; color: #94a3b8;">
            You are receiving this because your organisation has large donation notifications enabled.
        </p>
    </div>
</body>
</html>
