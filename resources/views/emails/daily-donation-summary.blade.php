...
<body style="font-family: 'Plus Jakarta Sans', sans-serif; line-height: 1.6; color: #1a1a2e; background-color: #f8fafc;">
    <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <div style="margin-bottom: 32px;">
            <h1 style="margin: 0 0 4px; font-size: 22px; font-weight: 700; color: #0f766e;">Daily Donation Report</h1>
            <p style="margin: 0; font-size: 14px; color: #64748b;">{{ now()->format('d M Y') }} &middot; {{ $organization->name }}</p>
        </div>

        {{-- Summary row --}}
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 16px; background: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e2e8f0;">
            <tr>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 32px; background: #f8fafc; border-radius: 8px; overflow: hidden; border: 1px solid #e2e8f0;">
            <tr>
                <td style="padding: 14px 24px; border-right: 1px solid #e2e8f0; width: 50%;">
                    <div style="font-size: 11px; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 2px;">One-time</div>
                    <div style="font-size: 18px; font-weight: 700; color: #1a1a2e;">{{ $oneTimeCount }} <span style="font-size: 13px; font-weight: 400; color: #64748b;">donations</span></div>
                    <div style="font-size: 14px; color: #0f766e; font-weight: 600;">RM {{ $oneTimeTotal }}</div>
                </td>
                <td style="padding: 14px 24px; width: 50%;">
                    ...
                    <div style="font-size: 18px; font-weight: 700; color: #1a1a2e;">{{ $recurringCount }} <span style="font-size: 13px; font-weight: 400; color: #64748b;">donations</span></div>
                    <div style="font-size: 14px; color: #0f766e; font-weight: 600;">RM {{ $recurringTotal }}</div>
                </td>
            </tr>
        </table>
