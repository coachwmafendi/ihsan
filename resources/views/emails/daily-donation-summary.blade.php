...
<body style="font-family: 'Plus Jakarta Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #1a1a2e; background-color: #f8fafc; margin: 0; padding: 0;">
    ...
    <div style="max-width: 600px; margin: 0 auto; padding: 24px 16px;">
        ...
        <div style="margin-bottom: 24px;">
            ...
            <p class="email-small" style="margin: 0; font-size: 13px; color: #64748b;">{{ myrTime(now(), withLabel: false, format: 'd M Y') }} &middot; {{ $organization->name }}</p>
        </div>
        ...
        <div style="background: #ffffff; border-radius: 12px; border: 1px solid #e2e8f0; margin-bottom: 24px; overflow: hidden; display: flex; flex-wrap: wrap;">
            <div style="flex: 1; padding: 16px; min-width: 140px; box-sizing: border-box; border-bottom: 1px solid #e2e8f0;">
                ...
                <div class="email-value" style="font-size: 15px; color: #0f766e; font-weight: 600;">{{ $hasApproximation ? "≈ MYR" : "MYR" }} {{ $oneTimeTotal }}</div>
            </div>
            <div style="flex: 1; padding: 16px; min-width: 140px; box-sizing: border-box;">
                ...
                <div class="email-value" style="font-size: 15px; color: #0f766e; font-weight: 600;">{{ $hasApproximation ? "≈ MYR" : "MYR" }} {{ $recurringTotal }}</div>
            </div>
        </div>
        ...
        <div style="margin-top: 32px; padding-top: 20px; border-top: 1px solid #e2e8f0;">
            <p class="email-small" style="margin: 0 0 4px; font-size: 12px; color: #94a3b8;">
                You are receiving this because your organization has daily donation summary enabled.
            </p>
