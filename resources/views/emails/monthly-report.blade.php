...
<body style="font-family: 'Plus Jakarta Sans', sans-serif; line-height: 1.6; color: #1a1a2e;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tr><td style="padding: 8px; border-bottom: 1px solid #e2e8f0; color: #64748b;">Total Amount</td><td style="padding: 8px; border-bottom: 1px solid #e2e8f0; font-weight: 600;">{{ $hasApproximation ? "≈ MYR" : "MYR" }} {{ $totalAmount }}</td></tr>
        </table>
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                ...
                @foreach ($campaigns as $campaign)
                    <tr>
                        ...
                        <td style="padding: 8px; border-bottom: 1px solid #e2e8f0;">{{ $hasApproximation ? "≈ MYR" : "MYR" }} {{ $campaign['total'] }}</td>
                    </tr>
                @endforeach
            </table>
        @endif
