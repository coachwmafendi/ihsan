...
<body style="font-family: 'Plus Jakarta Sans', sans-serif; line-height: 1.6; color: #1a1a2e;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p>A donation of <strong>{{ $donation->currency_symbol }} {{ number_format($donation->gross_amount, 2) }}</strong> for <strong>{{ $donation->campaign->title }}</strong> has been refunded.</p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tr><td style="padding: 8px; border-bottom: 1px solid #e2e8f0; color: #64748b;">Amount Refunded</td><td style="padding: 8px; border-bottom: 1px solid #e2e8f0; font-weight: 600; color: #dc2626;">{{ $donation->currency_symbol }} {{ number_format($donation->gross_amount, 2) }}</td></tr>
