<div style="border-top: 1px solid #e2e8f0; padding-top: 16px; margin-top: 24px; font-size: 0.875rem; color: #64748b; line-height: 1.6;">
    <p class="email-small" style="margin: 0 0 8px;">
        ...
        <a href="mailto:support@getihsan.my" style="color: #0d9488; text-decoration: underline;">support@getihsan.my</a>
    ...
    <p class="email-small" style="margin: 0;">Sent with ❤️ from Ihsan</p>
</div>
