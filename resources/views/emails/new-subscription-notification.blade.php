...
<body style="font-family: Manrope, sans-serif; line-height: 1.6; color: #1a1a2e;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p><strong>{{ $donation->donor->name }}</strong> has started a recurring subscription of <strong>RM {{ number_format($donation->gross_amount, 2) }}</strong> for <strong>{{ $donation->campaign->title }}</strong>.</p>
