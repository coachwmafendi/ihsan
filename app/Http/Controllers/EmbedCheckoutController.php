...
(function () {
    ...
    function ensureModal() {
        ...
        modal.innerHTML = '<div style="position:relative;width:min(100%,460px);height:min(92vh,760px);background:#fff;border-radius:18px;box-shadow:0 24px 80px rgba(15,23,42,.28);overflow:hidden;"><button type="button" data-ihsan-close style="position:absolute;top:10px;right:10px;z-index:2;width:34px;height:34px;border:0;border-radius:999px;background:rgba(15,23,42,.08);font:24px/1 system-ui,sans-serif;cursor:pointer;">&times;</button><iframe title="Ihsan checkout" data-ihsan-frame style="width:100%;height:100%;border:0;" allow="payment *"></iframe></div>';
