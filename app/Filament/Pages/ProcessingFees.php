            ...
            ->filters([
                ...
                Filter::make('created_at')
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        return $query
                            ->when($data['date_from'] ?? null, fn (Builder $q, $d): Builder => $q->where('created_at', '>=', ReportingPeriod::platform()->parseLocalDate((string) $d)->startOfDay()->utc()))
                            ->when($data['date_to'] ?? null, fn (Builder $q, $d): Builder => $q->where('created_at', '<=', ReportingPeriod::platform()->parseLocalDate((string) $d)->endOfDay()->utc()));
                    }),
            ])
